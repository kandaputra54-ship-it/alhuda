...
export const weeklySchedule: Record<string, DaySchedule> = {
  ...
  Rabu: {
    subuh: { utama: "Nashrullah", badal: "M.Syamsudin", muadzin: "Nuryaman" },
    dzuhur: { utama: "Dewa Alfian", badal: "Kanda Putra", muadzin: "Rusman" },
    ashar: { utama: "Dewa Alfian", badal: "Kanda Putra", muadzin: "Rafki" },
  ...
  Kamis: {
    ...
    maghrib: { utama: "Azan Saleh ", badal: "Kanda Putra", muadzin: "Azan Saleh", }, 
  ...
  Jumat: {
    ...
    jumat: { khatib: "Prof.Dr.Bunyamin", imam: "Syakir Abdullah", muadzin: "Muadzin Jumat", },
    ashar: { utama: "Tedi Koswara ", badal: "Azan Saleh", muadzin: "Satria" },
    maghrib: { utama: "Tedi Koswara", badal: "Kanda Putra", muadzin: "Azan Saleh", },
    isya: { utama: "Galuh Yogaswara", badal: "Kanda Putra", muadzin: "Azan Saleh" },
  },
  Sabtu: {
    ...
    isya: { utama: "Syakir Abdullah", badal: "Azan Saleh", muadzin: "Tedi Koswara", },
  },
  Minggu: {
    subuh: { utama: "Syakir Abdullah", badal: "Azan Saleh", muadzin: "M. Syamsudin", },
    dzuhur: { utama: "Azan Saleh", badal: "Tedi Koswara", muadzin: " Remaja" },
    ashar: { utama: "Azan Saleh", badal: "Tedi Koswara", muadzin: "Ipan" },
    maghrib: { utama: "Syakir Abdullah", badal: "Tedi Koswara", muadzin: "M. Syamsudin", },
    isya: { utama: "Syakir Abdullah", badal: "Tedi Koswara", muadzin: "M. Syamsudin", },
  },
};
