...
export const weeklySchedule: Record<string, DaySchedule> = {
  ...
  Jumat: {
    ...
    isya: { utama: "Galuh Yogaswara", badal: "Azan Saleh", muadzin: "Azan Saleh" },
  },
  Sabtu: {
    subuh: {
      utama: "M. Syamsudin",
      badal: "Kanda Putra",
      muadzin: "Tedi Koswara",
    },
